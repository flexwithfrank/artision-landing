              ...
              <a class="group block h-56">
                <div class="relative flex h-full items-end rounded-3xl border-4 border-black bg-gray-50 p-8 transition group-hover:-translate-x-2 group-hover:-translate-y-2 group-hover:shadow-[8px_8px_0_0_#000]">
                  ...
                  <div class="absolute opacity-0 lg:group-hover:relative lg:group-hover:opacity-100 ">
                    <h3 class="text-2xl font-bold">Common Operating Picture</h3>

                    <p class="mt-4 text-lg font-medium leading-relaxed">
                      Visualization and quantification for prescriptive action
              ...
              <a class="group block h-56">
                <div class="relative flex h-full items-end rounded-3xl border-4 border-black bg-gray-50 p-8 transition group-hover:-translate-x-2 group-hover:-translate-y-2 group-hover:shadow-[8px_8px_0_0_#000]">
                  ...
                  <div class="absolute opacity-0 lg:group-hover:relative lg:group-hover:opacity-100 ">
                    ...
                    <p class="mt-4 text-lg font-medium leading-relaxed">
                      People, Process, Technology, and infrastructure get
                      smarter over time.
                    </p>
                  </div>
                </div>
              ...
              <a class="group block h-56">
                <div class="relative flex h-full items-end rounded-3xl border-4 border-black bg-gray-50 p-8 transition group-hover:-translate-x-2 group-hover:-translate-y-2 group-hover:shadow-[8px_8px_0_0_#000]">
                  <div class="lg:group-hover:absolute lg:group-hover:opacity-0 ">
                    ...
                    <p class="mt-4 text-xl font-bold sm:text-3xl">Operations</p>
                  </div>
...
export default SolutionsDetailsV2;
