            ...
            <div className="overflow-hidden rounded-lg bg-white shadow-md ring-1 ring-black ring-opacity-5">
              ...
              <div className="pt-5 pb-6">
                <div className="space-y-1 px-2">
                  {navigation.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="block rounded-md px-3 py-2 text-base font-medium text-gray-900 hover:bg-gray-50 foa-book"
                    >
                      {item.name}
                    </a>
                  ))}
                ...
                <div className="mt-6 px-5">
                  <Link
                    to="/contact"
                    className="block w-full rounded-md bg-blue-800 py-3 px-4 text-center text-lg font-medium text-white shadow hover:bg-blue-700 foa"
                  >
                    Contact Us
                  </Link>
                </div>
