...
export default function Form() {
  return (
    <>
    <header className="relative bg-blue-800 pb-24 sm:pb-32 mt-6">
      ...
      <div className="relative mx-auto max-w-7xl lg:grid lg:grid-cols-5">
        <div className="bg-white py-16 px-4 sm:px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
          <div className="mx-auto max-w-lg">
            ...
            Artesion’s mission is to be a leader in resilient platform systems and infrastructure projects.
            </p>
              ...
              <div className="mt-6">
                ...
                <dd className="flex">
                  <PhoneIcon
                    ...
                    aria-hidden="true"
                  />
                  <span className="ml-3">+1 253 203 3125</span> <span className="ml-3">Fax +1 253 203 3101</span>
                </dd>
              </div>
              <div className="mt-3">
